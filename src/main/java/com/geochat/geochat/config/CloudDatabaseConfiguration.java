package com.geochat.geochat.config;
...
@Configuration
@EnableMongoRepositories("com.geochat.geochat.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.geochat.geochat.config.dbmigrations");
